...
def main():
    ...
    for table_name in TABLE_NAMES:
        ...
        upload_to_adls(table_data, f'{table_name}.json', 'datalake', 'data_lake')

    # Extract data from JSON file
    json_data = extract_from_json()
    upload_to_adls(json_data, 'reviews_users.json', 'datalake', 'data_lake')

    # Extract data from CSV file
    csv_data = extract_from_csv()
    upload_to_adls(csv_data, 'users_data.csv', 'datalake', 'data_lake')
